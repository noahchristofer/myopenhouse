                ...
                >
                    <View style={{ width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0)', borderRadius: 10, paddingBottom: 20, justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ width: '100%', backgroundColor: colors.whiteColor, paddingTop: 15, paddingBottom: 5, borderRadius: 10, maxHeight: 300, }}>
                            <Text style={{ fontSize: 16, fontFamily: fonts.ExtraBold, color: colors.secondaryColor, textAlign: 'center' }}>Please Select</Text>
                            <ScrollView>
                                {this.props.children}
                            </ScrollView>
                            <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'flex-end', marginTop: 15 }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    <Text style={{ fontSize: 14, fontFamily: fonts.Bold, color: colors.dangerColor }}>Cancel</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
...
export const MyPickerItem = (props) => {
    return (
        <TouchableOpacity
            ...
            <Text style={{ fontSize: 14, fontFamily: fonts.SemiBold, color: colors.blackColor, marginLeft: 15, width: '70%' }}>{props.value}</Text>
        </TouchableOpacity>
    );
}
